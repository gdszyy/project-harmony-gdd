# godot_project/scripts/scenes/test_chamber.gd 函数索引

> 自动生成于 2026-05-08 | 总行数: 1235 | 函数数: 65 | 语言: gdscript
...
| `_connect_beat_signal` | function | `_connect_beat_signal()` |  |
| `_on_beat_tick_3d` | function | `_on_beat_tick_3d(beat_index: int)` |  |
| `_sync_projectiles_to_3d` | function | `_sync_projectiles_to_3d()` |  |
| `_register_enemy_3d` | function | `_register_enemy_3d(enemy: Node2D, enemy_type: String)` |  |
| `_unregister_enemy_3d` | function | `_unregister_enemy_3d(enemy: Node2D)` |  |
| `_cycle_chapter_visual` | function | `_cycle_chapter_visual()` |  |
| `_toggle_3d_layer` | function | `_toggle_3d_layer()` |  |
| `_on_enemy_killed_vfx` | function | `_on_enemy_killed_vfx(pos: Vector2, enemy_type: String = "static")` |  |
...
| `spawn_enemy` | function | `spawn_enemy(enemy_type: String, count: int = 1, position_mode: String = "random")` |  |
| `_get_spawn_position` | function | `_get_spawn_position(mode: String, index: int, total: int)` |  |
| `spawn_wave_preset` | function | `spawn_wave_preset(preset_name: String)` |  |
| `_spawn_wave_preset` | function | `_spawn_wave_preset(preset_name: String)` |  |
| `_clear_all_enemies` | function | `_clear_all_enemies()` |  |
| `get_enemy_count` | function | `get_enemy_count()` |  |
| `_check_collisions` | function | `_check_collisions()` |  |
| `_get_enemy_collision_data` | function | `_get_enemy_collision_data()` |  |
...
| `_draw_arena_grid` | function | `_draw_arena_grid()` |  |
| `_draw_arena_border` | function | `_draw_arena_border()` |  |
| `_draw_hitboxes` | function | `_draw_hitboxes()` |  |
| `_on_enemy_died` | function | `_on_enemy_died(pos: Vector2, xp_value: int, enemy_type: String)` |  |
...
| `_log` | function | `_log(text: String)` |  |
...
```bash
grep -n "函数名" godot_project/scripts/scenes/test_chamber.gd
```
