...
const VOL3_CHAPTER_ENEMIES: Dictionary = {
	...
	"ch6_walking_bass": {
		"name": "行走贝斯",
		"subtitle": "第六章 · 爵士即兴",
		"description": "爵士时代的特色敌人。以爵士乐中经典的\"行走低音\"节奏缓慢而坚定地移动，每一步都在战场上留下低频共振区域，踩入其中的玩家移速降低。",
		"chapter": 6,
		"rarity": Rarity.RARE,
		"unlock_type": UnlockType.ENCOUNTER,
	},
	...
	"ch7_bitcrusher_worm": {
		"name": "比特破碎虫",
		"subtitle": "第七章 · 数字前沿",
		"description": "电子音乐时代的特色敌人。蠕虫状的数字生物，由多个像素块段组成，各段分辨率不同。经过的地面会被\"降采样腐蚀\"，身体段数随时间增长，头部发射\"量化噪音\"弹幕。被击中时身体段会断裂并释放碎片。",
		"chapter": 7,
		"rarity": Rarity.EPIC,
		"unlock_type": UnlockType.ENCOUNTER,
	},
