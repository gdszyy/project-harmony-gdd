...
【构造体视觉特征】
律动塔（C/G）：谐振青色，方块形态，强拍爆发
共鸣器（D/A）：圣光金色，八面体形态，持续光环
干扰场（E/F/B）：深邃紫色，三角形态，脉冲波纹

同类构造体靠近时会形成共鸣网络，产生能量连线并获得增益。",
		"intervals": [0, 3, 7, 10],
		"spell_form": "召唤/构造",
		"multiplier": 0.8,
		"dissonance": 2.5,
...
const VOL2_TIMBRES: Dictionary = {
	...
	"timbre_lyre": {
		"name": "里拉琴",
		"subtitle": "泛音共鸣",
		"description": "第一章专属音色。核心机制「泛音共鸣」：基于数学比例的伤害加成。视觉特征：水墨扩散 + 金色光点 + 弦振波形。\n\nADSR 参数：起音 0.08s / 衰减 0.20s / 持续 0.60 / 释放 0.15s。波形：三角波。",
		"family": "弹拨",
		"adsr": "起音 0.08s, 衰减 0.20s, 持续 0.60, 释放 0.15s",
		"mechanic": "基于数学比例的伤害加成",
		"rarity": Rarity.UNCOMMON,
		"unlock_type": UnlockType.CAST_SPELL,
	},
	"timbre_organ": {
		"name": "管风琴",
		"subtitle": "和声层叠",
		"description": "第二章专属音色。核心机制「和声层叠」：多声部叠加攻击，满层触发圣咏。视觉特征：圣光柱 + 彩色玻璃折射 + 多层光环。\n\nADSR 参数：起音 0.15s / 衰减 0.0s / 持续 0.90 / 释放 0.40s。波形：锯齿波。",
		"family": "吹奏",
		"adsr": "起音 0.15s, 衰减 0.0s, 持续 0.90, 释放 0.40s",
		"mechanic": "多声部叠加攻击",
		"rarity": Rarity.RARE,
		"unlock_type": UnlockType.CAST_SPELL,
	},
	"timbre_harpsichord": {
		"name": "羽管键琴",
		"subtitle": "对位交织",
		"description": "第三章专属音色。核心机制「对位交织」：镜像位置生成对位弹体。视觉特征：金属光泽 + 装饰音符粒子 + 机械齿轮。\n\nADSR 参数：起音 0.03s / 衰减 0.15s / 持续 0.45 / 释放 0.0s。波形：三角波。",
		"family": "弹拨",
		"adsr": "起音 0.03s, 衰减 0.15s, 持续 0.45, 释放 0.0s",
		"mechanic": "镜像位置生成对位弹体",
		"rarity": Rarity.RARE,
		"unlock_type": UnlockType.CAST_SPELL,
	},
	"timbre_fortepiano": {
		"name": "钢琴",
		"subtitle": "力度动态",
		"description": "第四章专属音色。核心机制「力度动态」：强弱拍伤害差异化。视觉特征：水晶折射 + 黑白键闪烁。\n\nADSR 参数：起音 0.02s / 衰减 0.10s / 持续 0.80 / 释放 0.08s。波形：正弦波。",
		"family": "打击",
		"adsr": "起音 0.02s, 衰减 0.10s, 持续 0.80, 释放 0.08s",
		"mechanic": "强弱拍伤害差异化",
		"rarity": Rarity.RARE,
		"unlock_type": UnlockType.CAST_SPELL,
	},
	"timbre_tutti": {
		"name": "管弦全奏",
		"subtitle": "情感爆发",
		"description": "第五章专属音色。核心机制「情感爆发」：渐强渐弱的伤害曲线，满量触发高潮。视觉特征：火焰渐变 + 情感强度驱动 + 混沌能量团。\n\nADSR 参数：起音 0.10s / 衰减 0.05s / 持续 0.85 / 释放 0.20s。波形：锯齿波。",
		"family": "拉弦",
		"adsr": "起音 0.10s, 衰减 0.05s, 持续 0.85, 释放 0.20s",
		"mechanic": "渐强渐弱的伤害曲线",
		"rarity": Rarity.EPIC,
		"unlock_type": UnlockType.CAST_SPELL,
	},
	"timbre_saxophone": {
		"name": "萨克斯",
		"subtitle": "摇摆攻击",
		"description": "第六章专属音色。核心机制「摇摆攻击」：反拍强化，S型弹道，触发即兴独奏。视觉特征：霓虹流光 + 烟雾扭曲 + 金色音符。\n\nADSR 参数：起音 0.06s / 衰减 0.10s / 持续 0.70 / 释放 0.12s。波形：正弦波。",
		"family": "吹奏",
		"adsr": "起音 0.06s, 衰减 0.10s, 持续 0.70, 释放 0.12s",
		"mechanic": "反拍强化，S型弹道",
		"rarity": Rarity.EPIC,
		"unlock_type": UnlockType.CAST_SPELL,
	},
	"timbre_synthesizer": {
		"name": "合成主脑",
		"subtitle": "波形变换",
		"description": "第七章专属音色。核心机制「波形变换」：四种基础波形切换。视觉特征：故障像素 + 波形可视化 + 几何形态。\n\nADSR 参数：起音 0.01s / 衰减 0.05s / 持续 0.75 / 释放 0.03s。波形：方波。",
		"family": "电子",
		"adsr": "起音 0.01s, 衰减 0.05s, 持续 0.75, 释放 0.03s",
		"mechanic": "四种基础波形切换",
		"rarity": Rarity.EPIC,
		"unlock_type": UnlockType.CAST_SPELL,
	},
