...
> **文档定位：技术美术蓝图 (The "How")**
> 本文档是《美术与VFX方向总文档》的技术实现方案。它基于对项目代码的全面审计，将美术愿景转化为可执行的架构决策、Shader方案和场景结构。它回答了“我们如何实现这些视觉效果？”的问题。
> 
> 查阅顶层艺术方向，请参阅配套的《美术圣经》：[Art_And_VFX_Direction.md](./Art_And_VFX_Direction.md)。
