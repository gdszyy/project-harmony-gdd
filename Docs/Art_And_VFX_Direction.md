...
> **文档定位：美术圣经 (The \"What\")**
> 本文档是项目的顶层艺术方向指南，定义了游戏的美学哲学、双极美学体系、全局色彩、章节风格、视觉语言等。它回答了“我们想要什么样的视觉效果？”的问题。
> 
> 对于如何将这些视觉效果在 Godot 引擎中技术实现，请参阅配套的《技术美术蓝图》：[ART_IMPLEMENTATION_FRAMEWORK.md](./ART_IMPLEMENTATION_FRAMEWORK.md)
